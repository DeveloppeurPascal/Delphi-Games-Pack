...
## Utiliser ces jeux vidéo

Consultez [le site de Gamolf](https://gamolf.fr) pour voir la liste des jeux disponibles, sur quelles plateformes, les télécharger et les acheter quand ils sont en vente.
...
[Ce dépôt de code](https://github.com/DeveloppeurPascal/Delphi-Games-Pack) et tous ses sous-projets sont disponibles sur [mon compte GitHub](https://github.com/DeveloppeurPascal).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Delphi-Games-Pack) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Delphi-Games-Pack/issues).
